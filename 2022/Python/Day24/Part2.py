...
def navigate(safe_cells, start_pos, end_pos, t=0):
...
def main():
    ...
    t1 = navigate(safe, start_pos, end_pos)
    t2 = navigate(safe, end_pos, start_pos, t=t1)
    t3 = navigate(safe, start_pos, end_pos, t=t2)
    print(t3)
